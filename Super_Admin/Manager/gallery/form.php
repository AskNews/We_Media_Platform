								...
								<form id="edit-profile" class="form-horizontal" action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="control-group">
										...
										<div class="control-group">											
											...
											<div class="controls">
												<input type="text" class="span6" id="location" name="location" value="<?php echo isset($editData)?$editData['location']:"";?><?php if(isset($vsLocation)){ echo $vsLocation;}?>" required>
