                            ...
                            <div class="table-responsive">
                                ...
                                <div class="row"><div class="col-sm-12"><table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                                    <thead>
                                        ...
                                        <th class="" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="width: 100px; height=50px;">User Name</th>
                                        ...
                                        <th class="" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Salary: activate to sort column ascending" style="width: 100px; height=50px;">View</th>
                                        </tr>
                                    </thead>
                                    <tfoot>
                                        <tr>
                                        <th rowspan="1" colspan="1">New Headline</th>
                                    ...
                                    <tr role="row" class="odd">
                                            ...
                                            <td>Tokyo</td>
                                            <td>like</td>
                                            <td><a herf=# class="btn btn-primary waves-effect">Approve</a>
                                            <a herf=# class="btn btn-Danger waves-effect">Dis-app</a>
                                            <a herf=# class="btn btn-warning waves-effect">Spam</a></td>
