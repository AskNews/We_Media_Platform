                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-cyan hover-expand-effect">
                        ...
                        <div class="content">
                            <div class="text">TODAY INCOME</div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-light-green hover-expand-effect">
                        ...
                        <div class="content">
                            <div class="text">INCOME OF PREVIOUS DAY</div>
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <form>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="accountno" class="form-control" placeholder="Enter your account number">
                                    </div>
                                </div>
