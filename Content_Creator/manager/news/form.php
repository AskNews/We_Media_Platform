                        ...
                        <div class="body">
                            ...
                            <div class="form-group form-float">
                                    ...
                                    <label class="form-label"></label>
                                        <input type="text" class="form-control" placeholder="New Headline" value="<?php echo @$update['HeadLine']; echo @$_POST['newsheadline']; ?>" id="newsheadline"  name="newsheadline" >
                                    </div>
                            ...
                            <div class="form-group form-float">
                                    <div class="form-line">
                                    <label class="form-label"></label>
                                        <input type="text" class="form-control"  placeholder="Summary" name="summary" value="<?php echo @$update['Summary']; echo @$_POST['summary'] ?>" onkeyup="convertToComa1(this.value);" id="summary" >    
                                    </div>
