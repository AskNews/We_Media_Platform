            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        <li class="has-sub">
                            <a class="js-arrow" href="AdIndex.php">
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <li>
                                    <a href="create_ad.php.html">Create New Ad</a>
                                </li>
                                <li>
                        ...
                        <li class="has-sub">
                            <a class="js-arrow" href="Feedback.php">
                                <i class="fas fa-tachometer-alt"></i>Feedback</a>
                        </li>
                        <li class="has-sub">
                            <a class="js-arrow" href="#">
                ...
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <li>
                                    <a href="create_ad.php">Create New Ad</a>
                                </li>
                                <li>
                            ...
                            <div class="header-button">
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        <div class="content">
                                            <a class="js-acc-btn" href="#">Priyanka Patel</a>
                                        </div>
