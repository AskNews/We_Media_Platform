...
if($data){
  ...
  if(isset($_GET['news'])){
    ...
    $url='"'.$_GET['news'].'"';
    $fqry=mysqli_query($con,'select * from tbl_news where slug='.$url.' and Status=1 and Offline=0');
   // echo 'select * from tbl_news where slug='.$url.' and Status=1 and Offline=0';
