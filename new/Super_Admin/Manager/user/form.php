...
<input class="wmp-input" type="text" name="uname" value="<?php echo @$editData['user_name'];?>">
<br>
<label>First Name</label>
<input class="wmp-input" type="text" name="fname" value="<?php echo @$editData['first_name'];?>">
<br>
<label>Last Name</label>
<input class="wmp-input" type="text" name="lname" value="<?php echo @$editData['last_name'];?>">
<br>
<label>Email</label>
<input class="wmp-input" type="email" name="email" value="<?php echo @$editData['email'];?>">
<br>
<label>Password</label>
<input class="wmp-input" type="password" name="pwd" value="<?php echo @$editData['password'];?>">
<br>
<label>Password</label>
<input class="wmp-input" type="password" >
<br>
<?php
        $sub='';
		$operator='';
	...
	<?php
		...
		?>
			...
			<?php
				  if(isset($editData)){
	?>
	<button type="submit" class="wmp-button wmp-purple" name="u_<?php echo $type;?>"><i class="fa fa-plus-square"> Update &nbsp;<?php echo ucfirst($type);?> &nbsp;Details</i></button>
										
      <input type="hidden" name="id" value="<?php echo $editData['id'];?>" />
      <?php
	}else{
	  ?>
<button type="submit" class="wmp-button wmp-purple" name="c_<?php echo $type;?>"> Create <?php echo ucfirst($type);?></button>
<?php
	}
	  ?>
   <br><br>
